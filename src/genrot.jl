...
function rotstressvec!(::Type{DeforModelRed2DStrain},
    ...
    outstress[4] = (a13^2) * instress[1] +
                   (a23^2) * instress[2] +
                   (a33^2) * instress[4] +
                   (2 * a13 * a23) * instress[3]
    outstress[3] = a11 * a12 * instress[1] +
                   a21 * a22 * instress[2] +
                   a31 * a32 * instress[4] +
